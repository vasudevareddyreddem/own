<!-- footer -->
    ...
    <script src="<?php echo site_url(); ?>assets/vendor/js/price-range.js"></script>   
    <script src="<?php echo site_url(); ?>assets/vendor/js/main.js"></script>
	<script src="<?php echo site_url(); ?>assets/vendor/js/switcher.js"></script>
	</body>
